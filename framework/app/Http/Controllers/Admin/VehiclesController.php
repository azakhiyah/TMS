...
class VehiclesController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view("vehicles.edit", compact('vehicle', 'groups', 'drivers', 'udfs', 'types'));
    }
    ...
    public function update(VehicleRequest $request)
    {
        ...
        if ($request->file('truck_image') && $request->file('truck_image')->isValid()) {
            $this->upload_file($request->file('truck_image'), "truck_image", $vehicle);
        }

        $user = VehicleModel::find($request->get("id"));
        $form_data = $request->all();
        unset($form_data['truck_image']);
    ...
    public function store(VehicleRequest $request)
    {
        ...
        $vehicle = VehicleModel::create([
            ...
            'vin' => $request->get("vin"),
            'machine_no' =>$request->get("required"),
        ...
        if ($request->file('truck_image') && $request->file('truck_image')->isValid()) {
            $this->upload_file($request->file('truck_image'), "truck_image", $truck);
        }
