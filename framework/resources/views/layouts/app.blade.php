...
<!-- 
          ...
          @if(in_array(6,$modules)) <li class="nav-item has-treeview {{$class}}">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('customers.index') }}" class="nav-link @if((Request::is('admin/customers*') && !(Request::is('admin/customers/create')))) active @endif">
                <i class="fa fa-"></i>
                  <i class="fa fa-list nav-icon"></i>
                   <p>@lang('Manage Customers')</p>
                 </a>
               </li>
            </ul>
          </li> 
         ...
         @if(Request::is('admin/masterdata*'))
            @php($class="menu-open")
            @php($active="active")
          ...
          @if(in_array(6,$modules)) <li class="nav-item has-treeview {{$class}}">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ route('clocation.index') }}" class="nav-link @if((Request::is('admin/clocation*') && !(Request::is('admin/clocation/create')))) active @endif">
                <i class="fa fa-"></i>
                  <i class="fa fa-address-book nav-icon"></i>
                   <p>@lang('Customers Location')</p>
                 </a>
               </li>
           
              <li class="nav-item">
                <a href="{{ route('depo.index') }}" class="nav-link @if((Request::is('admin/depo*') && !(Request::is('admin/depo/create')))) active @endif">
                <i class="fa fa-"></i>
              ...
              <li class="nav-item">
                <a href="{{ route('drivers.index') }}" class="nav-link @if((Request::is('admin/drivers*') && !(Request::is('admin/drivers/create')))) active @endif">
                <i class="fa fa-"></i>
              ...
              <li class="nav-item">
                <a href="{{ route('product.index') }}" class="nav-link @if((Request::is('admin/product*') && !(Request::is('admin/product/create')))) active @endif">
                <i class="fa fa-"></i>
              ...
              <li class="nav-item">
                <a href="{{ route('trailers.index') }}" class="nav-link @if((Request::is('admin/trailers*') && !(Request::is('admin/trailers/create')))) active @endif">
                <i class="fa fa-"></i>
              ...
              <li class="nav-item">
                <a href="{{ route('transporter.index') }}" class="nav-link @if((Request::is('admin/transporter*') && !(Request::is('admin/transporter/create')))) active @endif">
                <i class="fa fa-"></i>
                  <i class="fa fa-wpexplorer nav-icon"></i>
                   <p>@lang('Transporter')</p>
                 </a>
               </li>
           
              <li class="nav-item">
                <a href="{{ route('trucks.index') }}" class="nav-link @if((Request::is('admin/truck*') && !(Request::is('admin/truck/create')))) active @endif">
                <i class="fa fa-"></i>
            ...
            <li class="nav-item">
                <a href="{{ route('truck-types.index')}}" class="nav-link @if(Request::is('admin/truck-types*')) active @endif">
                  <i class="fa fa-th-list nav-icon"></i>
                  <p>@lang('Truck Types')</p>
                </a>
              </li>
           
              <li class="nav-item">
                <a href="{{ route('warehouse.index') }}" class="nav-link @if((Request::is('admin/warehouse*') && !(Request::is('admin/warehouse/create')))) active @endif">
                <i class="fa fa-"></i>
...
<!--          
         ...
         @endif -->
          ...
          @if(Request::is('admin/daily_transaction*'))
            @php($class="menu-open")
            @php($active="active")
          ...
          <li class="nav-item has-treeview {{$class}}">
            ...
            @if(in_array(2,$modules))
              <li class="nav-item">
              <a href="{{ route('order_plan.index') }}" class="nav-link @if((Request::is('admin/daily_transaction/order_plan*')) && !(Request::is('admin/daily_transaction/order_plan/create')) && !(Request::is('admin/daily_transaction/order_plan/logs')) || Request::is('admin/parts-used*')) active @endif">
              ...
              <li class="nav-item">
              <a href="{{ route('pickup_bytransport.index') }}" class="nav-link @if((Request::is('admin/daily_transaction/pickup_bytransport*')) && !(Request::is('admin/daily_transaction/pickup_bytransport/create')) && !(Request::is('admin/daily_transaction/pickup_bytransport/logs')) || Request::is('admin/parts-used*')) active @endif">
                   <i class="fa fa-shopping-cart nav-icon"></i>
                   <p>@lang('Pickup by Transport')</p>
                 </a>
               </li>
              ...
              <li class="nav-item">
              <a href="{{ route('delivery_order.index') }}" class="nav-link @if((Request::is('admin/daily_transaction/delivery_order*')) && !(Request::is('admin/daily_transaction/delivery_order/create')) && !(Request::is('admin/daily_transaction/delivery_order/logs')) || Request::is('admin/parts-used*')) active @endif">
                   <i class="fa fa-send nav-icon"></i>
                   <p>@lang('Delivery Order')</p>
                 </a>
               </li>
               @endif
            </ul>
         ...
         @if(Request::is('admin/transporter*'))
            @php($class="menu-open")
            @php($active="active")
         ...
         <!-- @if(Request::is('admin/truck*'))
          ...
          @if(in_array(6,$modules)) <li class="nav-item has-treeview {{$class}}">
            ...
            <li class="nav-item">
                <a href="{{ route('truck-types.index')}}" class="nav-link @if(Request::is('admin/truck-types*')) active @endif">
                  <i class="fa fa-th-list nav-icon"></i>
                  <p>@lang('fleet.manage_truck_types')</p>
                </a>
              </li>
            </ul>
          </li> 
...
<!--         
          ...
          <!--
          @if(Request::is('admin/order_plan*') || Request::is('admin/parts-used*'))
            @php($class="menu-open")
            @php($active="active")
          ...
          @if(in_array(7,$modules)) <li class="nav-item has-treeview {{$class}}">
            <a href="#" class="nav-link {{$active}}">
              ...
              <p>
                @lang('fleet.Pickup By Transport')
                <i class="right fa fa-angle-left"></i>
              </p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('order_plan.create') }}" class="nav-link @if(Request::is('admin/order_plan/create')) active @endif">
                  <i class="fa fa-plus-square nav-icon"></i>
                  <p> @lang('fleet.add_order_plan')</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('order_plan.index') }}" class="nav-link @if((Request::is('admin/order_plan*')) && !(Request::is('admin/order_plan/create')) && !(Request::is('admin/order_plan/logs')) || Request::is('admin/parts-used*')) active @endif">
                  <i class="fa fa-inbox nav-icon"></i>
                  <p>@lang('fleet.manage_order_plan')</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ url('admin/order_plan/logs') }}" class="nav-link @if(Request::is('admin/order_plan/logs')) active @endif">
                  <i class="fa fa-history nav-icon"></i>
                  <p>@lang('fleet.order_plan_logs')</p>
                </a>
              </li>
            </ul>
          </li> @endif
