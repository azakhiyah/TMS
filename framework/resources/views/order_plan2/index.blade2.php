...
@section("breadcrumb")
<li class="breadcrumb-item active">@lang('fleet.order_plan')</li>
@endsection
@section('extra_css')
<style type="text/css">
  .checkbox, #chk_all{
  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title">
        @lang('fleet.order_plan')
        &nbsp;
        <a href="{{ route('order_plan.create')}}" class="btn btn-success">@lang('fleet.create_orderplan')</a></h3>
      </div>
        ...
        <table class="table" id="data_table">
          <thead class="thead-inverse">
            <tr>
              ...
              <th>@lang('fleet.order_plan_price')</th>
