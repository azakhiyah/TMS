...
@endsection
@section("breadcrumb")
<li class="breadcrumb-item">{{ link_to_route('pickup_bytransport.index', __('fleet.pick'))}}</li>
<li class="breadcrumb-item active">@lang('fleet.pick_add')</li>
  ...
  <div class="col-md-12">
    <div class="card card-success">
      <div class="card-header">
        <h3 class="card-title">@lang('fleet.pick_add')</h3>
      </div>
      ...
      {!! Form::open(['route' => 'pickup_bytransport.store','method'=>'post','files'=>true]) !!}
      ...
      <div class="row">
       ...
       <div class="col-md-6">
        ...
        <div class="col-md-6">
              <div class="form-group">
                {!! Form::label('planning_at',__('fleet.pick_planning_at'), ['class' => 'col-xs-5 control-label required']) !!}
                  ...
                  {!! Form::text('planning_at', null,['class' => 'form-control','required','autocomplete' => 'off']) !!}
                  </div>
              </div>
            </div>
        ...
        {{-- <div class="col-md-6">
              <div class="form-group">
                    {!! Form::label('depo_id',__('fleet.pick_depo'), ['class' => 'form-label']) !!}
                    {!! Form::text('depo_id',null,['class'=>'form-control','required']) !!}
            </div>
        </div>  --}}
        ...
        <div class="col-md-6">
              <div class="form-group">
                    ...
                    <select id="trucks_id"
                            ...
                            <option value="">--- Select Truck ---</option>
                              ...
                              <option value="{{$trucks->id}}" data-id="{{$trucks->id}}">{{$trucks->door_number}}</option>
                              @endforeach
                    </select>
              </div>
        </div>
                ...
                <div class="col-xs-6">
                 ...
                 <option value="">--- Select Trailers ---</option>
                   @foreach($trailers as $trailers)
                    <option value="{{$trailers->id}}">{{$trailers->brand}}</option>
                   @endforeach
                 </select>
                </div>
              </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {!! Form::select('compartement',["1"=>"1", "2"=>"2", "3"=>"3", "4"=>"4"],null,['class'=>'form-control','required']) !!}
                </div>
            </div> 
            <div class="col-md-6">
              <div class="form-group">
                {!! Form::label('statuspickup',__('fleet.pick_statuspickup'), ['class' => 'form-label']) !!}
                {!! Form::select('statuspickup',["Pending"=>"Pending", "Processing"=>"Processing", "Completed"=>"Completed"],null,['class' => 'form-control','required']) !!}
              </div>
            </div>
        ...
        <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="input-group-prepend">
                  ...
                  {!! Form::text('start_loading', null,['class' => 'form-control','required','autocomplete' => 'off']) !!}
                  </div>
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="input-group-prepend">
                  ...
                  {!! Form::text('stop_loading', null,['class' => 'form-control','required','autocomplete' => 'off']) !!}
                  </div>
              </div>
            </div>
