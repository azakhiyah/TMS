...
<li class="breadcrumb-item active">@lang('fleet.product_add')</li>
@endsection
@section('content')
<div class="row">
  <div class="col-md-12">
    <div class="card card-success">
      <div class="card-header">
        <h3 class="card-title">@lang('fleet.product_add')</h3>
      </div>
       ...
       <div class="row">  
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              {!! Form::text('density',null,['class'=>'form-control','required']) !!}
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-12">
            {!! Form::submit(__('fleet.product_add'), ['class' => 'btn btn-success']) !!}
          </div>
          {!! Form::close() !!}
        </div>
      </div>
