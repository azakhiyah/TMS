        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <select id='language' name='language' class="form-control" required>
              ...
              <option value="es" @if(Hyvikk::frontend('language')=="es") selected @endif> Spanish </option>
              <option value="ar" @if(Hyvikk::frontend('language')=="ar") selected @endif> Arabic </option>
            </select>
          </div>
          </div>
