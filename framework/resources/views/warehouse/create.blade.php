...
<li class="breadcrumb-item active">@lang('fleet.wh_add_warehouse')</li>
@endsection
@section('content')
<div class="row">
  <div class="col-md-12">
    <div class="card card-success">
      <div class="card-header">
        <h3 class="card-title">@lang('fleet.wh_add_warehouse')</h3>
      </div>
       ...
       <div class="row">  
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              {!! Form::email('email_WH',null,['class'=>'form-control','required']) !!}
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
            {!! Form::submit(__('fleet.wh_add_warehouse'), ['class' => 'btn btn-success']) !!}
          </div>
          </div>
          {!! Form::close() !!}
        </div>
