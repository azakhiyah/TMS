...
<li class="breadcrumb-item active">@lang('fleet.add_order_plan')</li>
@endsection
@section('content')
<div class="row">
  <div class="col-md-12">
    <div class="card card-success">
      ...
      <div class="card-body">
        ...
        {!! Form::open(['route' => 'order_plan.store','method'=>'post']) !!}
        ...
        <div class="row">
          <div class="col-md-12">
            {!! Form::submit(__('fleet.add_order_plan'), ['class' => 'btn btn-success']) !!}
          </div>
        </div>
      </div>
    </div>
