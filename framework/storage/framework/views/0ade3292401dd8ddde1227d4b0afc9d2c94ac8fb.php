...
<li class="breadcrumb-item active"><?php echo app('translator')->getFromJson('fleet.transporter_add_transporter'); ?></li>
  ...
  <div class="col-md-12">
    <div class="card card-success">
      <div class="card-header">
        <h3 class="card-title"><?php echo app('translator')->getFromJson('fleet.transporter_add_transporter'); ?></h3>
      </div>
    ...
    <div class="card-body">
      ...
      <div class="tab-content">
        ...
        <?php echo Form::open(['route' => 'transporter.store','method'=>'post']); ?>
       ...
       <div class="row">  
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <?php echo Form::email('email_transporter',null,['class'=>'form-control','required']); ?>
        ...
        <div class="row">
          <div class="col-md-12">
            <?php echo Form::submit(__('fleet.transporter_add_transporter'), ['class' => 'btn btn-success']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.2.28\htdocs\tms\framework\resources\views/transporter/create.blade.php ENDPATH**/ ?>