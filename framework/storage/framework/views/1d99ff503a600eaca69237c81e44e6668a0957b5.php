...
<li class="breadcrumb-item active"><?php echo app('translator')->getFromJson('fleet.pick'); ?></li>
  ...
  <div class="col-md-12">
    ...
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title"><?php echo app('translator')->getFromJson('fleet.pick'); ?> &nbsp;
        <a href="<?php echo e(route('pickup_bytransport.create')); ?>" class="btn btn-success"><?php echo app('translator')->getFromJson('fleet.pick_add'); ?></a></h3>
      </div>
        ...
        <table class="table" id="data_table">
          <thead class="thead-inverse">
            <tr>
              ...
              <th><?php echo app('translator')->getFromJson('fleet.pick_qty_order'); ?></th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo e($row->customers->name); ?></td>
              
              <td><?php echo e($row->depo->name); ?></td>
              <td><?php echo e($row->product->name); ?></td>
              <td><?php echo e($row->qty_order); ?></td>
              
              
              <td><?php echo e($row->start_loading); ?></td>
              <td><?php echo e($row->stop_loading); ?></td>
              ...
              <a class="dropdown-item" href="<?php echo e(url("admin/pickup_bytransport/".$row->id."/edit")); ?>"> <span aria-hidden="true" class="fa fa-edit" style="color: #f0ad4e;"></span> <?php echo app('translator')->getFromJson('fleet.edit'); ?></a>
              ...
              <a class="dropdown-item openBtn" data-id="<?php echo e($row->id); ?>" data-toggle="modal" data-target="#myModal2" id="openBtn">
                    <span class="fa fa-eye" aria-hidden="true" style="color: #398439"></span> <?php echo app('translator')->getFromJson('fleet.view_data'); ?>
                    </a>
              <a class="dropdown-item" href="<?php echo e(url('admin/pickup_bytransport/viewcetak/'.$row->id)); ?>"><span aria-hidden="true" class="fa fa-list" style="color: #31b0d5;"></span> <?php echo app('translator')->getFromJson('fleet.pick_viewcetak'); ?>
                    </a>
              </div>
              </div>
              <?php echo Form::open(['url' => 'admin/pickup_bytransport/'.$row->id,'method'=>'DELETE','class'=>'form-horizontal','id'=>'form_'.$row->id]); ?>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php echo Form::open(['url'=>'admin/delete-pickup_bytransport','method'=>'POST','id'=>'form_delete']); ?>
...
<div id="myModal2" class="modal fade" role="dialog" tabindex="-1">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title"><?php echo app('translator')->getFromJson('fleet.pick'); ?></h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
...
<script type="text/javascript">
  ...
  $('.openBtn').click(function(){
    ...
    $('#myModal2 .modal-body').load('<?php echo e(url("admin/pickup_bytransport/event")); ?>/'+id,function(result){
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.2.28\htdocs\tms\framework\resources\views/pickup_bytransport/index.blade.php ENDPATH**/ ?>