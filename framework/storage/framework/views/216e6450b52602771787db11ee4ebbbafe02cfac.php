  ...
  <div class="row">
    <div class="col-12">
      <h4>
        ...
        <small class="float-right"> <b><?php echo app('translator')->getFromJson('fleet.date'); ?> : </b><?php echo e(date($date_format_setting,strtotime($i->booking_income->date))); ?></small>
      </h4>
    </div>
  </div>
      ...
      <div class="table-responsive">
        <table class="table">
          ...
          <tr>
            ...
            <td>
            <?php echo e($booking->vehicle['make']); ?> - <?php echo e($booking->vehicle['model']); ?> - <?php echo e($booking->vehicle['license_plate']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.2.28\htdocs\tms\framework\resources\views/bookings/receipt.blade.php ENDPATH**/ ?>