  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title"><?php echo app('translator')->getFromJson('menu.notifications'); ?></h3>
      </div>
      <div class="card-body table-responsive">
        <table class="table" id="data_table">
          ...
          <tbody>
            ...
            <tr>
              <td>
                <?php if($data->getMeta('profile_image') == null): ?>
                  <img src="<?php echo e(asset("assets/images/no-user.jpg")); ?>" height="70px" width="70px">
                <?php else: ?>
                  <img src="<?php echo e(asset('uploads/'.$data->getMeta('profile_image'))); ?>" height="70px" width="70px">
                <?php endif; ?>
              </td>
              <td>
              ...
              <td> <?php echo app('translator')->getFromJson('fleet.driver_licence'); ?> <?php echo e(date(Hyvikk::get('date_format'),strtotime($notification->data['msg']))); ?></td>
              <td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.2.28\htdocs\tms\framework\resources\views/notifications/driver_notification.blade.php ENDPATH**/ ?>