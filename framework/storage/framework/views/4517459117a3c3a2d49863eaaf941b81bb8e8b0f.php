...
<li class="breadcrumb-item active"><?php echo app('translator')->getFromJson('fleet.vehicle_inspection'); ?></li>
  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title">
        <?php echo app('translator')->getFromJson('fleet.vehicle_inspection'); ?>
        &nbsp;
        <a href="<?php echo e(url('admin/vehicle-reviews-create')); ?>" class="btn btn-success"><?php echo app('translator')->getFromJson('fleet.add_vehicle_inspection'); ?></a></h3>
      </div>
        ...
        <table class="table" id="data_table" style="padding-bottom: 25px">
          <thead class="thead-inverse">
            <tr>
              ...
              <th><?php echo app('translator')->getFromJson('fleet.review_by'); ?></th>
              <th><?php echo app('translator')->getFromJson('fleet.reg_no'); ?></th>
          ...
          <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              ...
              <td><?php echo e($r->vehicle->make); ?> - <?php echo e($r->vehicle->model); ?> - <?php echo e($r->vehicle->types['displayname']); ?></td>
              ...
              <td>
                <div class="btn-group">
                  ...
                  <div class="dropdown-menu custom" role="menu">
                    <a class="dropdown-item" href="<?php echo e(url("admin/vehicle-review/".$r->id."/edit")); ?>"> <span aria-hidden="true" class="fa fa-edit" style="color: #f0ad4e;"></span> <?php echo app('translator')->getFromJson('fleet.edit'); ?></a>
                    <?php echo Form::hidden("id",$r->id); ?>

                    <a class="dropdown-item" data-id="<?php echo e($r->id); ?>" data-toggle="modal" data-target="#myModal"><span aria-hidden="true" class="fa fa-trash" style="color: #dd4b39"></span> <?php echo app('translator')->getFromJson('fleet.delete'); ?></a>
                    <a class="dropdown-item" href="<?php echo e(url('admin/view-vehicle-review/'.$r->id)); ?>">
                    <span class="fa fa-eye" aria-hidden="true" style="color: #398439"></span> <?php echo app('translator')->getFromJson('fleet.view'); ?>
                    </a>
                  </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Programs\xampp2\htdocs\fleet-manager\framework\resources\views/vehicles/vehicle_review_index.blade.php ENDPATH**/ ?>