...
<li class="breadcrumb-item active"><?php echo app('translator')->getFromJson('fleet.do'); ?></li>
<?php $__env->stopSection(); ?>
  ...
  <div class="col-md-12">
    ...
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title"><?php echo app('translator')->getFromJson('fleet.do'); ?> &nbsp;<a href="<?php echo e(route('delivery_order.create')); ?>" class="btn btn-success"><?php echo app('translator')->getFromJson('fleet.do_add'); ?></a>
        ...
        <table class="table" id="data_table" style="padding-bottom: 25px">
          <thead class="thead-inverse">
            <tr>
              ...
              <th><?php echo app('translator')->getFromJson('fleet.do_address'); ?></th>
              ...
              <th><?php echo app('translator')->getFromJson('fleet.do_attachment1'); ?></th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php if($row->customers): ?><?php echo e($row->customers->name); ?><?php endif; ?></td>
              <td><?php if($row->customerslocation): ?><?php echo e($row->customerslocation->address); ?><?php endif; ?></td>
              <td><?php if($row->depo): ?><?php echo e($row->depo->name); ?><?php endif; ?></td>
              <td><?php if($row->product): ?><?php echo e($row->product->name); ?><?php endif; ?></td>
              <td><?php echo e($row->qty_delivery); ?></td>
              <td><?php echo e($row->attachment1); ?></td>
              <td>
              <div class="btn-group">
              ...
              <a class="dropdown-item" href="<?php echo e(url("admin/delivery_order/".$row->id."/edit")); ?>"> <span aria-hidden="true" class="fa fa-edit" style="color: #f0ad4e;"></span> <?php echo app('translator')->getFromJson('fleet.edit'); ?></a>
              ...
              <a class="dropdown-item openBtn" data-id="<?php echo e($row->id); ?>" data-toggle="modal" data-target="#myModal2" id="openBtn">
                    <span class="fa fa-eye" aria-hidden="true" style="color: #398439"></span> <?php echo app('translator')->getFromJson('fleet.do_view'); ?>
                    </a>
              </div>
              </div>
              <?php echo Form::open(['url' => 'admin/delivery_order/'.$row->id,'method'=>'DELETE','class'=>'form-horizontal','id'=>'form_'.$row->id]); ?>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php echo Form::open(['url'=>'admin/delete-delivery_order','method'=>'POST','id'=>'form_delete']); ?>
...
<div id="myModal2" class="modal fade" role="dialog" tabindex="-1">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title"><?php echo app('translator')->getFromJson('fleet.do'); ?></h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
...
<script type="text/javascript">
  ...
  $('.openBtn').click(function(){
    ...
    $('#myModal2 .modal-body').load('<?php echo e(url("admin/delivery_order/event")); ?>/'+id,function(result){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.2.28\htdocs\tms\framework\resources\views/delivery_order/index.blade.php ENDPATH**/ ?>