...
<li class="breadcrumb-item active"><?php echo app('translator')->getFromJson('fleet.add_order_plan'); ?></li>
<?php $__env->stopSection(); ?>
  ...
  <div class="col-md-12">
    <div class="card card-success">
      <div class="card-header">
        <h3 class="card-title">
          <?php echo app('translator')->getFromJson('fleet.create_orderplan'); ?>
        </h3>
      </div>
      ...
      <div class="card-body">
        ...
        <?php echo Form::open(['route' => 'order_plan.store','method'=>'post']); ?>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              <?php echo Form::label('price',__('fleet.order_plan_price'), ['class' => 'form-label']); ?>
        ...
        <div class="row">
          <div class="col-md-12">
            <?php echo Form::submit(__('fleet.add_order_plan'), ['class' => 'btn btn-success']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.2.28\htdocs\tms\framework\resources\views/work_orders/create.blade.php ENDPATH**/ ?>