  ...
  <div class="col-md-12">
    <div class="card card-warning">
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <?php echo Form::text('required_by',$data->required_by,['class'=>'form-control','required']); ?>
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <?php echo Form::number('price',$data->price,['class'=>'form-control','required']); ?>
        ...
        <div class="row">
          <?php $__currentLoopData = $data->parts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="row col-md-12"><div class="col-md-4">  <div class="form-group"> <label class="form-label"><?php echo app('translator')->getFromJson('fleet.selectPart'); ?></label> <select  class="form-control" disabled>  <option value="<?php echo e($row->part_id); ?>" selected ><?php echo e($row->part->title); ?></option> </select> </div></div> <div class="col-md-2">  <div class="form-group"> <label class="form-label"><?php echo app('translator')->getFromJson('fleet.qty'); ?></label> <input type="number" name="parts[<?php echo e($row->part_id); ?>]" min="1" value="<?php echo e($row->qty); ?>" class="form-control" required disabled> </div></div>
          <div class="col-md-2">  <div class="form-group"> <label class="form-label"><?php echo app('translator')->getFromJson('fleet.unit_cost'); ?></label> <input type="number" value="<?php echo e($row->price); ?>" class="form-control" disabled> </div></div><div class="col-md-2">  <div class="form-group"> <label class="form-label"><?php echo app('translator')->getFromJson('fleet.total_cost'); ?></label> <input type="number" value="<?php echo e($row->price * $row->qty); ?>" class="form-control" disabled > </div></div>
          <div class="col-md-2"> <div class="form-group" style="margin-top: 30px"><a class="btn btn-danger" href="<?php echo e(url('admin/remove-part/'.$row->id)); ?>">Remove</a> </div></div></div>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.2.28\htdocs\tms\framework\resources\views/work_orders/edit.blade.php ENDPATH**/ ?>