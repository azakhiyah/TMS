      ...
      <nav class="mt-2">
        ...
        <?php if(!Auth::guest() &&  Auth::user()->user_type!="D" && Auth::user()->user_type != "C" ): ?>
          ...
          <?php if(in_array(1,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            ...
            <?php ($active=""); ?>
            <?php endif; ?>
          <?php if(in_array(2,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            <a href="#" class="nav-link <?php echo e($active); ?>">
              <i class="nav-icon fa fa-money"></i>
              <p>
          ...
          <?php if(in_array(3,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo e(route('booking-quotation.index')); ?>" class="nav-link <?php if(Request::is('admin/booking-quotation*')): ?> active <?php endif; ?>">
...
<!-- 
          ...
          <?php if(in_array(6,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            <a href="#" class="nav-link <?php echo e($active); ?>">
              ...
              <p>
                <?php echo app('translator')->getFromJson('Customers'); ?>
                <i class="right fa fa-angle-left"></i>
              </p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(route('customers.index')); ?>" class="nav-link <?php if((Request::is('admin/customers*') && !(Request::is('admin/customers/create')))): ?> active <?php endif; ?>">
                <i class="fa fa-"></i>
                  <i class="fa fa-list nav-icon"></i>
                   <p><?php echo app('translator')->getFromJson('Manage Customers'); ?></p>
                 </a>
               </li>
            </ul>
          </li> 
         ...
         <?php if(Request::is('admin/masterdata*')): ?>
            <?php ($class="menu-open"); ?>
            <?php ($active="active"); ?>
          ...
          <?php if(in_array(6,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            <a href="#" class="nav-link <?php echo e($active); ?>">
              ...
              <p>
                <?php echo app('translator')->getFromJson('Master Data'); ?>
                <i class="right fa fa-angle-left"></i>
              </p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item">
                ...
                <i class="fa fa-"></i>
                  <i class="fa fa-user-circle nav-icon"></i>
                   <p><?php echo app('translator')->getFromJson('Customers'); ?></p>
                 </a>
               </li>
            
              <li class="nav-item">
                <a href="<?php echo e(route('clocation.index')); ?>" class="nav-link <?php if((Request::is('admin/clocation*') && !(Request::is('admin/clocation/create')))): ?> active <?php endif; ?>">
                <i class="fa fa-"></i>
                  <i class="fa fa-address-book nav-icon"></i>
                   <p><?php echo app('translator')->getFromJson('Customers Location'); ?></p>
                 </a>
               </li>
           
              <li class="nav-item">
                <a href="<?php echo e(route('depo.index')); ?>" class="nav-link <?php if((Request::is('admin/depo*') && !(Request::is('admin/depo/create')))): ?> active <?php endif; ?>">
                <i class="fa fa-"></i>
                  <i class="fa fa-industry nav-icon"></i>
                   <p><?php echo app('translator')->getFromJson('Depo'); ?></p>
                 </a>
               </li>
           
              <li class="nav-item">
                <a href="<?php echo e(route('drivers.index')); ?>" class="nav-link <?php if((Request::is('admin/drivers*') && !(Request::is('admin/drivers/create')))): ?> active <?php endif; ?>">
                <i class="fa fa-"></i>
                  <i class="fa fa-drivers-license nav-icon"></i>
                   <p><?php echo app('translator')->getFromJson('Drivers'); ?></p>
                 </a>
               </li>
            
              <li class="nav-item">
                <a href="<?php echo e(route('product.index')); ?>" class="nav-link <?php if((Request::is('admin/product*') && !(Request::is('admin/product/create')))): ?> active <?php endif; ?>">
                <i class="fa fa-"></i>
                  <i class="fa fa-product-hunt nav-icon"></i>
                   <p><?php echo app('translator')->getFromJson('Product'); ?></p>
                 </a>
               </li>
            
              <li class="nav-item">
                <a href="<?php echo e(route('trailers.index')); ?>" class="nav-link <?php if((Request::is('admin/trailers*') && !(Request::is('admin/trailers/create')))): ?> active <?php endif; ?>">
                <i class="fa fa-"></i>
                  <i class="fa fa-subway nav-icon"></i>
                   <p><?php echo app('translator')->getFromJson('Trailers'); ?></p>
                 </a>
               </li>
         
              <li class="nav-item">
                <a href="<?php echo e(route('transporter.index')); ?>" class="nav-link <?php if((Request::is('admin/transporter*') && !(Request::is('admin/transporter/create')))): ?> active <?php endif; ?>">
                <i class="fa fa-"></i>
                  <i class="fa fa-wpexplorer nav-icon"></i>
                   <p><?php echo app('translator')->getFromJson('Transporter'); ?></p>
                 </a>
               </li>
           
              <li class="nav-item">
                <a href="<?php echo e(route('trucks.index')); ?>" class="nav-link <?php if((Request::is('admin/truck*') && !(Request::is('admin/truck/create')))): ?> active <?php endif; ?>">
                <i class="fa fa-"></i>
                  <i class="fa fa-truck nav-icon"></i>
                   <p><?php echo app('translator')->getFromJson('Truck'); ?></p>
                 </a>
               </li>
           
            <li class="nav-item">
                <a href="<?php echo e(route('truck-types.index')); ?>" class="nav-link <?php if(Request::is('admin/truck-types*')): ?> active <?php endif; ?>">
                  <i class="fa fa-th-list nav-icon"></i>
                  <p><?php echo app('translator')->getFromJson('Truck Types'); ?></p>
                </a>
              </li>
           
              <li class="nav-item">
                <a href="<?php echo e(route('warehouse.index')); ?>" class="nav-link <?php if((Request::is('admin/warehouse*') && !(Request::is('admin/warehouse/create')))): ?> active <?php endif; ?>">
                <i class="fa fa-"></i>
                  <i class="fa fa-building-o nav-icon"></i>
                   <p><?php echo app('translator')->getFromJson('Warehouse'); ?></p>
                 </a>
               </li>
            </ul>
          </li> 
          <?php endif; ?> 
<!-- 
          <?php if(Request::is('admin/clocation*')): ?>
            <?php ($class="menu-open"); ?>
            <?php ($active="active"); ?>
          ...
          <?php if(in_array(6,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            <a href="#" class="nav-link <?php echo e($active); ?>">
              <i class="fa fa-address-book nav-icon"></i>
              <p>
                <?php echo app('translator')->getFromJson('Cust. Location'); ?>
                <i class="right fa fa-angle-left"></i>
              </p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item">
                ...
                <i class="fa fa-"></i>
                  <i class="fa fa-map nav-icon"></i>
                   <p><?php echo app('translator')->getFromJson('Manage Cust. Location'); ?></p>
                 </a>
               </li>
            </ul>
          </li> 
...
<!--          
         <?php if(Request::is('admin/depo*')): ?>
          ...
          <?php if(in_array(6,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            <a href="#" class="nav-link <?php echo e($active); ?>">
              <i class="fa fa-industry nav-icon "></i>
              <p>
                <?php echo app('translator')->getFromJson('Depo'); ?>
                <i class="right fa fa-angle-left"></i>
              </p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item">
                ...
                <i class="fa fa-"></i>
                  <i class="fa fa-list nav-icon"></i>
                   <p><?php echo app('translator')->getFromJson('Manage Depo'); ?></p>
                 </a>
               </li>
            </ul>
          </li> 
         ...
         <!-- <?php if(Request::is('admin/drivers*')): ?>
          ...
          <?php if(in_array(6,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            <a href="#" class="nav-link <?php echo e($active); ?>">
              <i class="fa fa-drivers-license nav-icon "></i>
              <p>
                <?php echo app('translator')->getFromJson('Drivers'); ?>
                <i class="right fa fa-angle-left"></i>
              </p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item">
                ...
                <i class="fa fa-"></i>
                  <i class="fa fa-list nav-icon"></i>
                   <p><?php echo app('translator')->getFromJson('Manage Drivers'); ?></p>
                 </a>
               </li>
            </ul>
          </li> 
         ...
         <!-- <?php if(Request::is('admin/product*')): ?>
          ...
          <?php if(in_array(6,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            <a href="#" class="nav-link <?php echo e($active); ?>">
              <i class="fa fa-product-hunt nav-icon "></i>
              <p>
                <?php echo app('translator')->getFromJson('Product'); ?>
                <i class="right fa fa-angle-left"></i>
              </p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item">
                ...
                <i class="fa fa-"></i>
                  <i class="fa fa-list nav-icon"></i>
                   <p><?php echo app('translator')->getFromJson('Manage Product'); ?></p>
                 </a>
               </li>
            </ul>
          </li> 
         <?php endif; ?> -->
          ...
          <?php if(in_array(4,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            ...
            <ul class="nav nav-treeview">
              ...
              <?php if(in_array(0,$modules)): ?>
              <li class="nav-item">
                <a href="<?php echo e(route('reports.drivers')); ?>" class="nav-link <?php if(Request::is('admin/reports/drivers')): ?> active <?php endif; ?>">
                  <i class="fa fa-id-card nav-icon"></i>
              ...
              <?php if(in_array(2,$modules)): ?>
              <li class="nav-item">
                <a href="<?php echo e(route('reports.yearly')); ?>" class="nav-link <?php if(Request::is('admin/reports/yearly')): ?> active <?php endif; ?>">
                  <i class="fa fa-calendar nav-icon"></i>
                  <p><?php echo app('translator')->getFromJson('fleet.yearlyReport'); ?></p>
                </a>
              </li>
          ...
          <?php if(in_array(5,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo e(route('fuel.index')); ?>" class="nav-link <?php if(Request::is('admin/fuel*') && !Request::is('admin/fuel/create')): ?> active <?php endif; ?>">
                  <i class="fa fa-history nav-icon"></i>
          ...
          <?php if(Request::is('admin/daily_transaction*')): ?>
            <?php ($class="menu-open"); ?>
            <?php ($active="active"); ?>
          ...
          <li class="nav-item has-treeview <?php echo e($class); ?>">
            <a href="#" class="nav-link <?php echo e($active); ?>">
              ...
              <p>
                <?php echo app('translator')->getFromJson('Transaction'); ?>
                <i class="right fa fa-angle-left"></i>
              </p>
            </a>
            <ul class="nav nav-treeview">
            <?php if(in_array(2,$modules)): ?>
              <li class="nav-item">
              <a href="<?php echo e(route('order_plan.index')); ?>" class="nav-link <?php if((Request::is('admin/daily_transaction/order_plan*')) && !(Request::is('admin/daily_transaction/order_plan/create')) && !(Request::is('admin/daily_transaction/order_plan/logs')) || Request::is('admin/parts-used*')): ?> active <?php endif; ?>">
                   <i class="fa fa-shopping-basket nav-icon"></i>
                   <p><?php echo app('translator')->getFromJson('Order Plan'); ?></p>
                 </a>
               </li>

              <li class="nav-item">
              <a href="<?php echo e(route('pickup_bytransport.index')); ?>" class="nav-link <?php if((Request::is('admin/daily_transaction/pickup_bytransport*')) && !(Request::is('admin/daily_transaction/pickup_bytransport/create')) && !(Request::is('admin/daily_transaction/pickup_bytransport/logs')) || Request::is('admin/parts-used*')): ?> active <?php endif; ?>">
                   <i class="fa fa-shopping-cart nav-icon"></i>
                   <p><?php echo app('translator')->getFromJson('Pickup by Transport'); ?></p>
                 </a>
               </li>
              ...
              <li class="nav-item">
              <a href="<?php echo e(route('delivery_order.index')); ?>" class="nav-link <?php if((Request::is('admin/daily_transaction/delivery_order*')) && !(Request::is('admin/daily_transaction/delivery_order/create')) && !(Request::is('admin/daily_transaction/delivery_order/logs')) || Request::is('admin/parts-used*')): ?> active <?php endif; ?>">
                   <i class="fa fa-send nav-icon"></i>
                   <p><?php echo app('translator')->getFromJson('Delivery Order'); ?></p>
                 </a>
               </li>
               <?php endif; ?>
            </ul>
         ...
         <?php endif; ?>
          ...
          <!-- <?php if(Request::is('admin/trailers*')): ?>
            <?php ($class="menu-open"); ?>
            <?php ($active="active"); ?>
          ...
          <?php if(in_array(6,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            <a href="#" class="nav-link <?php echo e($active); ?>">
              <i class="fa fa-subway nav-icon "></i>
              <p>
                <?php echo app('translator')->getFromJson('Trailers'); ?>
                <i class="right fa fa-angle-left"></i>
              </p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item">
                ...
                <i class="fa fa-"></i>
                  <i class="fa fa-list nav-icon"></i>
                   <p><?php echo app('translator')->getFromJson('Manage Trailers'); ?></p>
                 </a>
               </li>
            </ul>
          </li> 
         ...
         <?php if(Request::is('admin/transporter*')): ?>
            <?php ($class="menu-open"); ?>
            <?php ($active="active"); ?>
          ...
          <?php if(in_array(6,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            <a href="#" class="nav-link <?php echo e($active); ?>">
              <i class="fa fa-wpexplorer nav-icon "></i>
              <p>
                <?php echo app('translator')->getFromJson('Transporter'); ?>
                <i class="right fa fa-angle-left"></i>
              </p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item">
                ...
                <i class="fa fa-"></i>
                  <i class="fa fa-wpexplorer nav-icon"></i>
                   <p><?php echo app('translator')->getFromJson('Manage Transporter'); ?></p>
                 </a>
               </li>
            </ul>
          </li> 
         ...
         <!-- <?php if(Request::is('admin/truck*')): ?>
          ...
          <?php if(in_array(6,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            <a href="#" class="nav-link <?php echo e($active); ?>">
              <i class="fa fa-truck nav-icon "></i>
              <p>
                <?php echo app('translator')->getFromJson('Truck'); ?>
                <i class="right fa fa-angle-left"></i>
              </p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item">
                ...
                <i class="fa fa-"></i>
                  <i class="fa fa-truck nav-icon"></i>
                   <p><?php echo app('translator')->getFromJson('Manage Truck'); ?></p>
                 </a>
               </li>
            </ul>
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('truck-types.index')); ?>" class="nav-link <?php if(Request::is('admin/truck-types*')): ?> active <?php endif; ?>">
                  <i class="fa fa-th-list nav-icon"></i>
                  <p><?php echo app('translator')->getFromJson('fleet.manage_truck_types'); ?></p>
                </a>
              </li>
            </ul>
          </li> 
         <?php endif; ?> -->
          ...
          <?php if(in_array(6,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(route('vendors.create')); ?>"class="nav-link <?php if(Request::is('admin/vendors/create')): ?> active <?php endif; ?>">
                  <i class="fa fa-plus-square nav-icon"></i>
                <p> <?php echo app('translator')->getFromJson('fleet.add_vendor'); ?></p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(route('vendors.index')); ?>" class="nav-link <?php if((Request::is('admin/vendors*') && !(Request::is('admin/vendors/create')))): ?> active <?php endif; ?>">
        ...
        <?php endif; ?> -->
           ...
           <!-- <?php if(Request::is('admin/warehouse*')): ?>
            <?php ($class="menu-open"); ?>
            <?php ($active="active"); ?>
          ...
          <?php if(in_array(6,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            <a href="#" class="nav-link <?php echo e($active); ?>">
              <i class="fa fa-building-o nav-icon "></i>
              <p>
                <?php echo app('translator')->getFromJson('Warehouse'); ?>
                <i class="right fa fa-angle-left"></i>
              </p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item">
                ...
                <i class="fa fa-"></i>
                  <i class="fa fa-building-o nav-icon"></i>
                   <p><?php echo app('translator')->getFromJson('Manage Warehouse'); ?></p>
                 </a>
               </li>
            </ul>
          </li> 
...
<!--         
           ...
           <?php if(in_array(14,$modules)): ?><li class="nav-item has-treeview <?php echo e($class); ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(route('parts.create')); ?>" class="nav-link <?php if(Request::is('admin/parts/create')): ?> active <?php endif; ?>">
                  <i class="fa fa-plus-square nav-icon"></i>
                  <p> <?php echo app('translator')->getFromJson('fleet.addParts'); ?></p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(route('parts.index')); ?>" class="nav-link <?php if(Request::is('admin/parts*') && !(Request::is('admin/parts-category*')) && !Request::is('admin/parts/create')): ?> active <?php endif; ?>">
          ...
          <!--
          <?php if(Request::is('admin/order_plan*') || Request::is('admin/parts-used*')): ?>
            <?php ($class="menu-open"); ?>
            <?php ($active="active"); ?>
          ...
          <?php if(in_array(7,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            <a href="#" class="nav-link <?php echo e($active); ?>">
              <i class="nav-icon fa fa-t"></i>
              <p>
                <?php echo app('translator')->getFromJson('fleet.Pickup By Transport'); ?>
                <i class="right fa fa-angle-left"></i>
              </p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(route('order_plan.create')); ?>" class="nav-link <?php if(Request::is('admin/order_plan/create')): ?> active <?php endif; ?>">
                  <i class="fa fa-plus-square nav-icon"></i>
                  <p> <?php echo app('translator')->getFromJson('fleet.add_order_plan'); ?></p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(route('order_plan.index')); ?>" class="nav-link <?php if((Request::is('admin/order_plan*')) && !(Request::is('admin/order_plan/create')) && !(Request::is('admin/order_plan/logs')) || Request::is('admin/parts-used*')): ?> active <?php endif; ?>">
                  <i class="fa fa-inbox nav-icon"></i>
                  <p><?php echo app('translator')->getFromJson('fleet.manage_order_plan'); ?></p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(url('admin/order_plan/logs')); ?>" class="nav-link <?php if(Request::is('admin/order_plan/logs')): ?> active <?php endif; ?>">
                  <i class="fa fa-history nav-icon"></i>
                  <p><?php echo app('translator')->getFromJson('fleet.order_plan_logs'); ?></p>
                </a>
              </li>
            </ul>
          </li> <?php endif; ?>
          ...
          <?php if(in_array(7,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo e(route('work_order.index')); ?>" class="nav-link <?php if((Request::is('admin/work_order*')) && !(Request::is('admin/work_order/create')) && !(Request::is('admin/work_order/logs')) || Request::is('admin/parts-used*')): ?> active <?php endif; ?>">
                  <i class="fa fa-inbox nav-icon"></i>
                  <p><?php echo app('translator')->getFromJson('fleet.manage_work_order'); ?></p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(url('admin/work_order/logs')); ?>" class="nav-link <?php if(Request::is('admin/work_order/logs')): ?> active <?php endif; ?>">
                  <i class="fa fa-history nav-icon"></i>
          ...
          <?php if(in_array(9,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            ...
            <?php ($active=""); ?>
            <?php endif; ?>
          <?php if(in_array(15,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            <a href="#" class="nav-link <?php echo e($active); ?>">
              <i class="nav-icon fa fa-quote-left"></i>
              <p>
                <?php echo app('translator')->getFromJson('fleet.testimonials'); ?>
                <i class="right fa fa-angle-left"></i>
              </p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(route('testimonials.index')); ?>" class="nav-link <?php if((Request::is('admin/testimonials*') && !(Request::is('admin/testimonials/create')))): ?> active <?php endif; ?>">
                  <i class="fa fa-tasks nav-icon"></i>
                  <p> <?php echo app('translator')->getFromJson('fleet.manage_testimonial'); ?></p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(route("testimonials.create")); ?>" class="nav-link <?php if(Request::is('admin/testimonials/create')): ?> active <?php endif; ?>">
                  <i class="fa fa-plus-square nav-icon"></i>
                  <p><?php echo app('translator')->getFromJson('fleet.add_testimonial'); ?></p>
                </a>
              </li>
            </ul>
          </li> <?php endif; ?>
          ...
          <li class="nav-item has-treeview <?php echo e($class); ?>">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo e(url('admin/api-settings')); ?>" class="nav-link <?php if(Request::is('admin/api-settings')): ?> active <?php endif; ?>">
                  <i class="fa fa-gear nav-icon"></i>
          ...
          <?php if(in_array(12,$modules) && Hyvikk::api('api_key') != null): ?> <li class="nav-item">
            <a href="<?php echo e(url('admin/driver-maps')); ?>" class="nav-link <?php if(Request::is('admin/driver-maps') || Request::is('admin/track-driver*')): ?> active <?php endif; ?>">
...
</html><?php /**PATH C:\xampp7.2.28\htdocs\tms\framework\resources\views/layouts/app.blade.php ENDPATH**/ ?>