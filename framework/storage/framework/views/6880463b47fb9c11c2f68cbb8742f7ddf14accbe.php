...
<li class="breadcrumb-item active"><?php echo app('translator')->getFromJson('fleet.customers_add'); ?></li>
  ...
  <div class="col-md-12">
    <div class="card card-success">
      <div class="card-header">
        <h3 class="card-title"><?php echo app('translator')->getFromJson('fleet.customers_add'); ?></h3>
      </div>
    ...
    <div class="card-body">
      ...
      <div class="tab-content">
       ...
       <div class="row">  
        ...
        <div class="row">
          <div class="col-md-12">
            <?php echo Form::submit(__('fleet.customers_add'), ['class' => 'btn btn-success']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.2.28\htdocs\tms\framework\resources\views/customers/create.blade.php ENDPATH**/ ?>