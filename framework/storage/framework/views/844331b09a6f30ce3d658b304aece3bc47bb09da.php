  ...
  <div class="col-md-12">
    ...
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title">
        <?php echo app('translator')->getFromJson('fleet.drivers'); ?>
        &nbsp;
        <a href="<?php echo e(route('drivers.create')); ?>" class="btn btn-success"><?php echo app('translator')->getFromJson('fleet.drivers_add'); ?></a>
        ...
        <table class="table" id="data_table">
          <thead class="thead-inverse">
            <tr>
              ...
              <th><?php echo app('translator')->getFromJson('fleet.drivers_name'); ?></th>
							<th><?php echo app('translator')->getFromJson('fleet.drivers_address'); ?></th>
							<th><?php echo app('translator')->getFromJson('fleet.drivers_phone'); ?></th>
							<th><?php echo app('translator')->getFromJson('fleet.drivers_sex'); ?></th>
							<th><?php echo app('translator')->getFromJson('fleet.drivers_sim_number'); ?></th>,
							<th><?php echo app('translator')->getFromJson('fleet.drivers_sim_exp_date'); ?></th>
							<th><?php echo app('translator')->getFromJson('fleet.drivers_image'); ?></th>
							<th><?php echo app('translator')->getFromJson('fleet.drivers_emergency_contact'); ?></th>
              <th><?php echo app('translator')->getFromJson('fleet.drivers_gatepass'); ?></th>
              <!-- <th><?php echo app('translator')->getFromJson('fleet.drivers_gatepass_rls_date'); ?></th> -->
              <th><?php echo app('translator')->getFromJson('fleet.drivers_gatepass_exp_date'); ?></th>
							<th><?php echo app('translator')->getFromJson('fleet.drivers_join_date'); ?></th>
          ...
          <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              ...
              <td><?php echo e($row->name); ?></td>
						  ...
						  <td><?php echo e($row->sim_exp_date); ?></td>
              <!-- <td>
              <?php if($row->driver_image != null): ?>
              <img src="<?php echo e(asset('uploads/'.$row->icon)); ?>" height="70px" width="70px">
              <?php else: ?>
              <img src="<?php echo e(asset("assets/images/truck.PNG")); ?>" height="70px" width="70px">
              <?php endif; ?>
              </td> -->
						  <td><?php echo e($row->driver_image); ?></td>
						  <td><?php echo e($row->emergency_contact); ?></td>
              <td><?php echo e($row->gatepass); ?></td>
              <!-- <td><?php echo e($row->gatepass_rls_date); ?></td> -->
              <td><?php echo e($row->gatepass_exp_date); ?></td>
              ...
              <div class="btn-group">
                ...
                <div class="dropdown-menu custom" role="menu">																																																																   
                  ...
                  <!-- <a class="dropdown-item openBtn" data-id="<?php echo e($row->id); ?>" data-toggle="modal" data-target="#myModal2" id="openBtn">
                    <span class="fa fa-eye" aria-hidden="true" style="color: #398439"></span> <?php echo app('translator')->getFromJson('fleet.drivers_view'); ?>
                    </a> -->
                </div>
              </div>
...
<div id="myModal2" class="modal fade" role="dialog" tabindex="-1">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title"><?php echo app('translator')->getFromJson('fleet.drivers'); ?></h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
...
<script type="text/javascript">
  ...
  $('.openBtn').click(function(){
    ...
    $('#myModal2 .modal-body').load('<?php echo e(url("admin/drivers/event")); ?>/'+id,function(result){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.2.28\htdocs\tms\framework\resources\views/drivers/index.blade.php ENDPATH**/ ?>