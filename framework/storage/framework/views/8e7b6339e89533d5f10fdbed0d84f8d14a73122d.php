      ...
      <div class="card-body table-responsive">
        <table class="table" id="data_table">
          ...
          <?php $__currentLoopData = $order->parts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              <td><?php echo e($row->workorder->vehicle->make); ?> - <?php echo e($row->workorder->vehicle->model); ?> - <?php echo e($row->workorder->vehicle->license_plate); ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/tms/framework/resources/views/work_orders/parts_used.blade.php ENDPATH**/ ?>