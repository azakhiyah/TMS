...
<li class="breadcrumb-item active"><?php echo app('translator')->getFromJson('fleet.truck'); ?></li>
<?php $__env->stopSection(); ?>
  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title"><?php echo app('translator')->getFromJson('fleet.managetruck'); ?> &nbsp; <a href="<?php echo e(route('truck.create')); ?>" class="btn btn-success"><?php echo app('translator')->getFromJson('fleet.addNew'); ?></a>
        ...
        <table class="table" id="data_table" style="padding-bottom: 25px">
          <thead class="thead-inverse">
            <tr>
              ...
              <th><?php echo app('translator')->getFromJson('fleet.truck_image'); ?></th>
              <th><?php echo app('translator')->getFromJson('fleet.truck_make'); ?></th>
              <th><?php echo app('translator')->getFromJson('fleet.truck_model'); ?></th>
              <th><?php echo app('translator')->getFromJson('fleet.truck_type'); ?></th>
              <th><?php echo app('translator')->getFromJson('fleet.truck_year'); ?></th>
              <th><?php echo app('translator')->getFromJson('fleet.truck_license_plate'); ?></th>
              <!--<th><?php echo app('translator')->getFromJson('fleet.truck_group_id'); ?></th>-->
              <th><?php echo app('translator')->getFromJson('fleet.truck_service'); ?></th>
              <!--<th><?php echo app('translator')->getFromJson('fleet.truck_assigned_driver'); ?></th>-->
          ...
          <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              ...
              <td>
                ...
                <img src="<?php echo e(asset('uploads/'.$row->truck_image)); ?>" height="70px" width="70px">
                <?php else: ?>
              ...
              <td>
                <div class="btn-group">
                  ...
                  <div class="dropdown-menu custom" role="menu">
                    <a class="dropdown-item" href="<?php echo e(url("admin/truck/".$row->id."/edit")); ?>"> <span aria-hidden="true" class="fa fa-edit" style="color: #f0ad4e;"></span> <?php echo app('translator')->getFromJson('fleet.edit'); ?></a>
                ...
                <?php echo Form::open(['url' => 'admin/truck/'.$row->id,'method'=>'DELETE','class'=>'form-horizontal','id'=>'form_'.$row->id]); ?>
          ...
          <tfoot>
            <tr>
              ...
              <th><?php echo app('translator')->getFromJson('fleet.truck_year'); ?></th>
              <th><?php echo app('translator')->getFromJson('fleet.truck_license_plate'); ?></th>
              <!--<th><?php echo app('translator')->getFromJson('fleet.truck_group'); ?></th>-->
              <th><?php echo app('translator')->getFromJson('fleet.truck_service'); ?></th>
              <!--<th><?php echo app('translator')->getFromJson('fleet.truck_assigned_driver'); ?></th>-->
              <th><?php echo app('translator')->getFromJson('fleet.action'); ?></th>
            </tr>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title"><?php echo app('translator')->getFromJson('fleet.importtruck'); ?></h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
        <?php echo Form::open(['url'=>'admin/import-truck','method'=>'POST','files'=>true]); ?>

        <div class="form-group">
          <?php echo Form::label('excel',__('fleet.importtruck'),['class'=>"form-label"]); ?>

          <?php echo Form::file('excel',['class'=>"form-control",'required']); ?>

        </div>
        <div class="form-group">
          <a href="<?php echo e(asset('assets/samples/truck.xlsx')); ?>"><?php echo app('translator')->getFromJson('fleet.downloadSampleExcel'); ?></a>
        </div>
        <div class="form-group">
...
<div id="bulkModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php echo Form::open(['url'=>'admin/delete-truck','method'=>'POST','id'=>'form_delete']); ?>
...
<div id="myModal2" class="modal fade" role="dialog" tabindex="-1">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title"><?php echo app('translator')->getFromJson('fleet.truck'); ?></h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
...
<script type="text/javascript">
  ...
  $('.openBtn').click(function(){
    ...
    $('#myModal2 .modal-body').load('<?php echo e(url("admin/truck/event")); ?>/'+id,function(result){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.2.28\htdocs\tms\framework\resources\views/truck/index.blade.php ENDPATH**/ ?>