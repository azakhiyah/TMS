...
<li class="breadcrumb-item active"><?php echo app('translator')->getFromJson('fleet.trailers'); ?></li>
<?php $__env->stopSection(); ?>
  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title"><?php echo app('translator')->getFromJson('fleet.manageTrailers'); ?> &nbsp; <a href="<?php echo e(route('trailers.create')); ?>" class="btn btn-success"><?php echo app('translator')->getFromJson('fleet.addNew'); ?></a>
        ...
        <table class="table" id="data_table" style="padding-bottom: 25px">
          <thead class="thead-inverse">
            <tr>
              ...
              <th><?php echo app('translator')->getFromJson('fleet.trailers_tag_id'); ?></th>
              ...
              <th><?php echo app('translator')->getFromJson('fleet.trailers_compartement'); ?></th>
          ...
          <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              ...
              <td><?php echo e($row->unit_maker); ?></td>
              <td><?php echo e($row->license_plate); ?></td>
              <td><?php echo e($row->tag_id); ?></td>
              <td><?php echo e($row->year); ?></td>
              <td><?php echo e($row->lic_exp_date); ?></td>
              <td><?php echo e($row->reg_exp_date); ?></td>
              <td><?php echo e($row->tera_sertifikat); ?></td>
              <td><?php echo e($row->tera_rls_date); ?></td>
              <td><?php echo e($row->tera_exp_date); ?></td>
              <!--<td><?php echo e($row->flowmeter); ?></td>-->
              <td><?php echo e($row->capacity); ?></td>
              <td><?php echo e($row->compartement); ?></td>
              <!-- <td><?php echo e(($row->C1)?"YES":"NO"); ?></td>
              <td><?php echo e(($row->C2)?"YES":"NO"); ?></td>
              <td><?php echo e(($row->C3)?"YES":"NO"); ?></td>
              <td><?php echo e(($row->C4)?"YES":"NO"); ?></td> -->
              <!--<td>
              ...
              <td>
                <div class="btn-group">
                  ...
                  <div class="dropdown-menu custom" role="menu">
                    <a class="dropdown-item" href="<?php echo e(url("admin/trailers/".$row->id."/edit")); ?>"> <span aria-hidden="true" class="fa fa-edit" style="color: #f0ad4e;"></span> <?php echo app('translator')->getFromJson('fleet.edit'); ?></a>
                    ...
                    <span class="fa fa-eye" aria-hidden="true" style="color: #398439"></span> <?php echo app('translator')->getFromJson('fleet.view_trailers'); ?>
                    </a>
                  </div>
                </div>
                <?php echo Form::open(['url' => 'admin/trailers/'.$row->id,'method'=>'DELETE','class'=>'form-horizontal','id'=>'form_'.$row->id]); ?>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title"><?php echo app('translator')->getFromJson('fleet.importTrailers'); ?></h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
        <?php echo Form::open(['url'=>'admin/import-trailers','method'=>'POST','files'=>true]); ?>

        <div class="form-group">
          <?php echo Form::label('excel',__('fleet.importTrailers'),['class'=>"form-label"]); ?>
...
<div id="bulkModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php echo Form::open(['url'=>'admin/delete-trailers','method'=>'POST','id'=>'form_delete']); ?>
...
<div id="myModal2" class="modal fade" role="dialog" tabindex="-1">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title"><?php echo app('translator')->getFromJson('fleet.trailers'); ?></h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
...
<script type="text/javascript">
  ...
  $('.openBtn').click(function(){
    ...
    $('#myModal2 .modal-body').load('<?php echo e(url("admin/trailers/event")); ?>/'+id,function(result){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.2.28\htdocs\tms\framework\resources\views/trailers/index.blade.php ENDPATH**/ ?>