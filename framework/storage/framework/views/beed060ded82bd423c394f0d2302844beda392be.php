        ...
        <table class="table" id="data_table" style="padding-bottom: 25px">
          <thead class="thead-inverse">
            <tr>
              ...
              <th><?php echo app('translator')->getFromJson('fleet.gender'); ?></th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo e(($row->gender) ? "Male" : "Female"); ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/tms/framework/resources/views/customers/index.blade.php ENDPATH**/ ?>