...
<li class="breadcrumb-item active"><?php echo app('translator')->getFromJson('fleet.vendors'); ?></li>
  ...
  <div class="col-md-12">
    ...
    <div class="card card-info">
      <div class="card-header">
        ...
        &nbsp;
        <a href="<?php echo e(route('vendors.create')); ?>" class="btn btn-success"><?php echo app('translator')->getFromJson('fleet.create_vendor'); ?></a>
            ...
            <tr>
              ...
              <td>
                <?php if($row->photo != null): ?>
                  <img src="<?php echo e(asset('uploads/'.$row->photo)); ?>" height="70px" width="70px">
                <?php else: ?>
              ...
              <td><?php echo e($row->address1); ?>

                <br>
                <?php echo e($row->address2); ?>

                &nbsp;
                <?php echo e($row->city); ?> <?php if($row->postal_code): ?> ,<?php echo e($row->postal_code); ?> <?php endif; ?>
                &nbsp;
              ...
              <div class="btn-group">
                ...
                <div class="dropdown-menu custom" role="menu">
                  <a class="dropdown-item" href="<?php echo e(url("admin/vendors/".$row->id."/edit")); ?>"><span aria-hidden="true" class="fa fa-edit" style="color: #f0ad4e;"></span> <?php echo app('translator')->getFromJson('fleet.edit'); ?></a>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title"><?php echo app('translator')->getFromJson('fleet.importVendors'); ?></h4>
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <a href="<?php echo e(asset('assets/samples/vendors.xlsx')); ?>"><?php echo app('translator')->getFromJson('fleet.downloadSampleExcel'); ?></a>
        </div>
        <div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.2.28\htdocs\tms\framework\resources\views/vendors/index.blade.php ENDPATH**/ ?>