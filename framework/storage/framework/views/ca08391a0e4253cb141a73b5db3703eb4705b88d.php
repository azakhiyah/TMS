        ...
        <table class="table" id="data_table" style="padding-bottom: 15px">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php if($row->vehicle_id != null): ?> <?php echo e($row->driver_vehicle->vehicle->make); ?>-<?php echo e($row->driver_vehicle->vehicle->model); ?>-<?php echo e($row->driver_vehicle->vehicle->license_plate); ?> <?php endif; ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Programs\xampp2\htdocs\fleet-manager\framework\resources\views/drivers/index.blade.php ENDPATH**/ ?>