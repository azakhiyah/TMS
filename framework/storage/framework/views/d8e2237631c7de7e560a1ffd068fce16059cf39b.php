...
<li class="breadcrumb-item active"><?php echo app('translator')->getFromJson('fleet.trucks'); ?></li>
  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title"><?php echo app('translator')->getFromJson('fleet.trucks'); ?> &nbsp;
        <a href="<?php echo e(route('trucks.create')); ?>" class="btn btn-success"><?php echo app('translator')->getFromJson('fleet.trucks_add'); ?></a></h3>
      </div>
        ...
        <table class="table" id="data_table">
          <thead class="thead-inverse">
            <tr>
              ...
              <th><?php echo app('translator')->getFromJson('fleet.trucks_service'); ?></th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <a class="dropdown-item" href="<?php echo e(url("admin/trucks/".$row->id."/edit")); ?>"> <span aria-hidden="true" class="fa fa-edit" style="color: #f0ad4e;"></span> <?php echo app('translator')->getFromJson('fleet.edit'); ?></a>
              ...
              <a class="dropdown-item openBtn" data-id="<?php echo e($row->id); ?>" data-toggle="modal" data-target="#myModal2" id="openBtn">
                    <span class="fa fa-eye" aria-hidden="true" style="color: #398439"></span> <?php echo app('translator')->getFromJson('fleet.view_trucks'); ?>
                    </a>
              </div>
              </div>
              <?php echo Form::open(['url' => 'admin/trucks/'.$row->id,'method'=>'DELETE','class'=>'form-horizontal','id'=>'form_'.$row->id]); ?>
...
<div id="myModal2" class="modal fade" role="dialog" tabindex="-1">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title"><?php echo app('translator')->getFromJson('fleet.trucks'); ?></h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
...
<script type="text/javascript">
  ...
  $('.openBtn').click(function(){
    ...
    $('#myModal2 .modal-body').load('<?php echo e(url("admin/trucks/event")); ?>/'+id,function(result){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.2.28\htdocs\tms\framework\resources\views/trucks/index.blade.php ENDPATH**/ ?>