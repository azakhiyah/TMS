...
<li class="breadcrumb-item active"><?php echo app('translator')->getFromJson('fleet.clocation'); ?></li>
  ...
  <div class="col-md-12">
    ...
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title">
        <?php echo app('translator')->getFromJson('fleet.clocation'); ?>
        &nbsp;
        <a href="<?php echo e(route('clocation.create')); ?>" class="btn btn-success"><?php echo app('translator')->getFromJson('fleet.clocation_add'); ?></a>
        ...
        <table class="table" id="data_table">
          <thead class="thead-inverse">
            <tr>
              ...
              <th><?php echo app('translator')->getFromJson('fleet.clocation_name'); ?></th>
              <th><?php echo app('translator')->getFromJson('fleet.clocation_address'); ?></th>
              <th><?php echo app('translator')->getFromJson('fleet.clocation_city'); ?></th>
              <th><?php echo app('translator')->getFromJson('fleet.clocation_province'); ?></th>
              <th><?php echo app('translator')->getFromJson('fleet.clocation_postal_code'); ?></th>
              <th><?php echo app('translator')->getFromJson('fleet.clocation_country'); ?></th>
              <th><?php echo app('translator')->getFromJson('fleet.clocation_longitude'); ?></th>
              <th><?php echo app('translator')->getFromJson('fleet.clocation_latitude'); ?></th>
              <th><?php echo app('translator')->getFromJson('fleet.clocation_phone'); ?></th>
              <th><?php echo app('translator')->getFromJson('fleet.clocation_email'); ?></th>
              <!-- <th><?php echo app('translator')->getFromJson('fleet.clocation_note'); ?></th> -->
          ...
          <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              ...
              <td><?php echo e($row->email_customer); ?></td>
              ...
              <div class="btn-group">
                ...
                <div class="dropdown-menu custom" role="menu">																																																																   
                  <a class="dropdown-item" href="<?php echo e(url("admin/clocation/".$row->id."/edit")); ?>"><span aria-hidden="true" class="fa fa-edit" style="color: #f0ad4e;"></span> <?php echo app('translator')->getFromJson('fleet.edit'); ?></a>
                  ...
                  <!-- <a class="dropdown-item openBtn" data-id="<?php echo e($row->id); ?>" data-toggle="modal" data-target="#myModal2" id="openBtn">
                    <span class="fa fa-eye" aria-hidden="true" style="color: #398439"></span> <?php echo app('translator')->getFromJson('fleet.clocation_view'); ?>
                    </a> -->
                </div>
              </div>
                <?php echo Form::open(['url' => 'admin/clocation/'.$row->id,'method'=>'DELETE','class'=>'form-horizontal','id'=>'form_'.$row->id]); ?>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php echo Form::open(['url'=>'admin/import-clocation','method'=>'POST','files'=>true]); ?>

        <div class="form-group">
          <?php echo Form::label('excel',__('fleet.importclocation'),['class'=>"form-label"]); ?>

          <?php echo Form::file('excel',['class'=>"form-control",'required']); ?>

        </div>
        <div class="form-group">
          <a href="<?php echo e(asset('assets/samples/clocation.xlsx')); ?>"><?php echo app('translator')->getFromJson('fleet.downloadSampleExcel'); ?></a>
        </div>
        <div class="form-group">
...
<div id="bulkModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php echo Form::open(['url'=>'admin/delete-clocation','method'=>'POST','id'=>'form_delete']); ?>
...
<div id="myModal2" class="modal fade" role="dialog" tabindex="-1">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title"><?php echo app('translator')->getFromJson('fleet.clocation'); ?></h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
...
<script type="text/javascript">
  ...
  $('.openBtn').click(function(){
    ...
    $('#myModal2 .modal-body').load('<?php echo e(url("admin/clocation/event")); ?>/'+id,function(result){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.2.28\htdocs\tms\framework\resources\views/clocation/index.blade.php ENDPATH**/ ?>