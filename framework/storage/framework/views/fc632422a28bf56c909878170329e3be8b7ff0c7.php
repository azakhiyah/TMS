      ...
      <div class="row">
        <div class="col-md-6">
              <div class="form-group">
                    <?php echo Form::label('truck_type', __('fleet.truck_type'), ['class' => 'form-label']); ?>

                    <?php echo Form::text('truck_type', null,['class' => 'form-control','required']); ?>
        ...
        <div class="form-group col-md-4" style="margin-top: 30px">
          <div class="row">
            ...
            <div class="col-md-9" style="margin-top: 5px">
              <h4><?php echo app('translator')->getFromJson('fleet.truck_type_isenable'); ?></h4>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card-footer">
        <div class="row">
          <div class="form-group col-md-4">
            <?php echo Form::submit(__('fleet.truck_type_save'), ['class' => 'btn btn-success']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.2.28\htdocs\tms\framework\resources\views/truck_type/create.blade.php ENDPATH**/ ?>